...
import { GarbageManagementChartLineEChartOption } from './garbage-management-chart-line-echart.option';
import {
  IGarbageManagementChartColor,
  IGarbageManagementChartData,
} from './garbage-management-chart-line.model';

@Component({
  selector: 'howell-garbage-management-chart-line',
  imports: [],
  templateUrl: './garbage-management-chart-line.component.html',
  styleUrl: './garbage-management-chart-line.component.less',
})
export class GarbageManagementChartLineComponent
