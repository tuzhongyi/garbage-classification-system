...
import { GarbageManagementRecordEventGarbageDropStatisticDetailsArgs } from './garbage-management-record-event-garbage-drop-statistic-details-container.model';

@Injectable()
export class GarbageManagementRecordEventGarbageDropStatisticDetailsContainerBusiness {
  constructor(
