...
import { GarbageManagementRecordEventGarbageDropStatisticDetailsContainerBusiness } from './business/garbage-management-record-event-garbage-drop-statistic-details-container.business';
import { GarbageManagementRecordEventGarbageDropStatisticDetailsArgs } from './business/garbage-management-record-event-garbage-drop-statistic-details-container.model';

@Component({
  selector:
    'howell-garbage-management-record-event-garbage-drop-statistic-details-container',
  imports: [CommonModule, GarbageManagementChartLineComponent],
  templateUrl:
    './garbage-management-record-event-garbage-drop-statistic-details-container.component.html',
  styleUrl:
    './garbage-management-record-event-garbage-drop-statistic-details-container.component.less',
  providers: [
    ...
    GarbageManagementRecordEventGarbageDropStatisticDetailsContainerBusiness,
  ],
})
export class GarbageManagementRecordEventGarbageDropStatisticDetailsContainerComponent
  implements OnInit, OnDestroy
{
  @Input() args =
    new GarbageManagementRecordEventGarbageDropStatisticDetailsArgs();
  @Input()
  load?: EventEmitter<GarbageManagementRecordEventGarbageDropStatisticDetailsArgs>;
  constructor(
    private business: GarbageManagementRecordEventGarbageDropStatisticDetailsContainerBusiness
  ) {}
  chart = {
    data: undefined as IGarbageManagementChartData | undefined,
    load: new EventEmitter<void>(),
    color: ColorTool.chart.line.record.garbagedrop,
    interval: 0,
  ...
  private data = {
    load: (
      args: GarbageManagementRecordEventGarbageDropStatisticDetailsArgs
    ) => {
