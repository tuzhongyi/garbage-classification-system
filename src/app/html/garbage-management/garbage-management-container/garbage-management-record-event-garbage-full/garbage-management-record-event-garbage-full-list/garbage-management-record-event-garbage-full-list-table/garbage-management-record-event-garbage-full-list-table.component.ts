...
import { GarbageManagementRecordEventGarbageFullListTableBusiness } from './garbage-management-record-event-garbage-full-list-table.business';
import {
...
@Component({
  selector: 'howell-garbage-management-record-event-garbage-full-list-table',
  imports: [
    CommonModule,
    PaginatorComponent,
    ImageDirective,
  ...
  templateUrl:
    './garbage-management-record-event-garbage-full-list-table.component.html',
  styleUrl:
    './garbage-management-record-event-garbage-full-list-table.component.less',
  providers: [GarbageManagementRecordEventGarbageFullListTableBusiness],
})
export class GarbageManagementRecordEventGarbageFullListTableComponent
  extends PagedTableAbstractComponent<GarbageFullEventRecordViewModel>
  implements OnInit
{
  @Input()
  load?: EventEmitter<GarbageManagementRecordEventGarbageFullListTableArgs>;
  @Input() args = new GarbageManagementRecordEventGarbageFullListTableArgs();
  ...
  on = {
    ...
    select: (item?: GarbageFullEventRecordViewModel) => {
      if (item) {
    ...
    download: {
      ...
      image: (e: Event, item?: GarbageFullEventRecordViewModel) => {
