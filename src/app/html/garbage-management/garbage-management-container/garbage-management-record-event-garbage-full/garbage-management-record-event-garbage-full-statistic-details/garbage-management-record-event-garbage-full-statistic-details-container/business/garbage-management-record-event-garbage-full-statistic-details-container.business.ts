...
import { GarbageManagementRecordEventGarbageFullStatisticDetailsArgs } from './garbage-management-record-event-garbage-full-statistic-details-container.model';

@Injectable()
export class GarbageManagementRecordEventGarbageFullStatisticDetailsContainerBusiness {
  constructor(
