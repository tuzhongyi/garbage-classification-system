...
import { GarbageManagementRecordEventGarbageFullStatisticDetailsContainerBusiness } from './business/garbage-management-record-event-garbage-full-statistic-details-container.business';
import { GarbageManagementRecordEventGarbageFullStatisticDetailsArgs } from './business/garbage-management-record-event-garbage-full-statistic-details-container.model';

@Component({
  selector:
    'howell-garbage-management-record-event-garbage-full-statistic-details-container',
  imports: [CommonModule, GarbageManagementChartLineComponent],
  templateUrl:
    './garbage-management-record-event-garbage-full-statistic-details-container.component.html',
  styleUrl:
    './garbage-management-record-event-garbage-full-statistic-details-container.component.less',
  providers: [
    ...
    GarbageManagementRecordEventGarbageFullStatisticDetailsContainerBusiness,
  ],
})
export class GarbageManagementRecordEventGarbageFullStatisticDetailsContainerComponent
  implements OnInit, OnDestroy
{
  @Input() args =
    new GarbageManagementRecordEventGarbageFullStatisticDetailsArgs();
  @Input()
  load?: EventEmitter<GarbageManagementRecordEventGarbageFullStatisticDetailsArgs>;
  constructor(
    private business: GarbageManagementRecordEventGarbageFullStatisticDetailsContainerBusiness
  ) {}
  chart = {
    data: undefined as IGarbageManagementChartData | undefined,
    load: new EventEmitter<void>(),
    color: ColorTool.chart.line.record.garbagefull,
    interval: 0,
  ...
  private data = {
    load: (
      args: GarbageManagementRecordEventGarbageFullStatisticDetailsArgs
    ) => {
