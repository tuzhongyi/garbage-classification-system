...
@Component({
  selector:
    'howell-garbage-management-record-event-garbage-full-statistic-details-manager',
  imports: [
    CommonModule,
    FormsModule,
    ...
    GarbageManagementRecordEventGarbageFullStatisticDetailsContainerComponent,
  ],
  templateUrl:
    './garbage-management-record-event-garbage-full-statistic-details-manager.component.html',
  styleUrl:
...
export class GarbageManagementRecordEventGarbageFullStatisticDetailsManagerComponent {
  ...
  chart = {
    args: new GarbageManagementRecordEventGarbageFullStatisticDetailsArgs(),
    load: new EventEmitter<GarbageManagementRecordEventGarbageFullStatisticDetailsArgs>(),
    station: {
