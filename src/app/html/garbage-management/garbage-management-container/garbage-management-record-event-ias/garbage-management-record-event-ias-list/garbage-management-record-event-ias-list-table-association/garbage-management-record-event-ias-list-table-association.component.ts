...
import { GarbageManagementRecordEventIasListTableBusiness } from '../garbage-management-record-event-ias-list-table/business/garbage-management-record-event-ias-list-table.business';
...
@Component({
  selector: 'howell-garbage-management-record-event-ias-list-table-association',
  imports: [CommonModule, PaginatorComponent],
  templateUrl:
    './garbage-management-record-event-ias-list-table-association.component.html',
  styleUrl:
    './garbage-management-record-event-ias-list-table-association.component.less',
  providers: [GarbageManagementRecordEventIasListTableBusiness],
})
export class GarbageManagementRecordEventIasListTableAssociationComponent
  ...
  implements OnInit, OnDestroy
{
  ...
  @Output() timeout = new EventEmitter<IasEventRecord>();
  ...
  on = {
    ...
    timeout: (e: Event, item: IasEventRecord) => {
      this.timeout.emit(item);
      if (this.selected === item) {
        e.stopImmediatePropagation();
      }
    },
