...
@Component({
  selector:
    'howell-garbage-management-record-event-illegal-drop-statistic-details-container',
  imports: [CommonModule, GarbageManagementChartLineComponent],
  templateUrl:
    './garbage-management-record-event-illegal-drop-statistic-details-container.component.html',
  styleUrl:
    './garbage-management-record-event-illegal-drop-statistic-details-container.component.less',
  providers: [
    ...
    GarbageManagementRecordEventIllegalDropStatisticDetailsContainerBusiness,
  ],
})
export class GarbageManagementRecordEventIllegalDropStatisticDetailsContainerComponent
  implements OnInit, OnDestroy
{
  @Input() args =
    new GarbageManagementRecordEventIllegalDropStatisticDetailsArgs();
  @Input()
  load?: EventEmitter<GarbageManagementRecordEventIllegalDropStatisticDetailsArgs>;
  constructor(
    private business: GarbageManagementRecordEventIllegalDropStatisticDetailsContainerBusiness
  ) {}
  chart = {
    data: undefined as IGarbageManagementChartData | undefined,
    load: new EventEmitter<void>(),
    color: ColorTool.chart.line.record.illegaldrop,
    interval: 0,
  ...
  private data = {
    load: (
      args: GarbageManagementRecordEventIllegalDropStatisticDetailsArgs
    ) => {
