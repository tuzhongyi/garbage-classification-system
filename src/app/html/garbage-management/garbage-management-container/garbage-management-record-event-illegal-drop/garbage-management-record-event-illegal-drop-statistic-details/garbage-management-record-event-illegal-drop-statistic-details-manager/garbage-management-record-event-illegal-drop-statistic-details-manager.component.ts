...
@Component({
  selector:
    'howell-garbage-management-record-event-illegal-drop-statistic-details-manager',
  imports: [
    CommonModule,
    FormsModule,
    ...
    GarbageManagementRecordEventIllegalDropStatisticDetailsContainerComponent,
  ],
  templateUrl:
    './garbage-management-record-event-illegal-drop-statistic-details-manager.component.html',
  styleUrl:
