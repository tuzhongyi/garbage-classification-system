...
import { GarbageManagementRecordEventIllegalVehicleStatisticDetailsContainerBusiness } from './garbage-management-record-event-illegal-vehicle-statistic-details-container.business';
import { GarbageManagementRecordEventIllegalVehicleStatisticDetailsArgs } from './garbage-management-record-event-illegal-vehicle-statistic-details-container.model';

@Component({
  selector:
    'howell-garbage-management-record-event-illegal-vehicle-statistic-details-container',
  imports: [CommonModule, GarbageManagementChartLineComponent],
  templateUrl:
    './garbage-management-record-event-illegal-vehicle-statistic-details-container.component.html',
  styleUrl:
    './garbage-management-record-event-illegal-vehicle-statistic-details-container.component.less',
  providers: [
    ...
    GarbageManagementRecordEventIllegalVehicleStatisticDetailsContainerBusiness,
  ],
})
export class GarbageManagementRecordEventIllegalVehicleStatisticDetailsContainerComponent
  implements OnInit, OnDestroy
{
  @Input() args =
    new GarbageManagementRecordEventIllegalVehicleStatisticDetailsArgs();
  @Input()
  load?: EventEmitter<GarbageManagementRecordEventIllegalVehicleStatisticDetailsArgs>;
  constructor(
    private business: GarbageManagementRecordEventIllegalVehicleStatisticDetailsContainerBusiness
  ) {}
  chart = {
  ...
  private data = {
    load: (
      args: GarbageManagementRecordEventIllegalVehicleStatisticDetailsArgs
    ) => {
