...
@Component({
  selector:
    'howell-garbage-management-record-event-illegal-vehicle-statistic-details-manager',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl:
    './garbage-management-record-event-illegal-vehicle-statistic-details-manager.component.html',
  styleUrl:
