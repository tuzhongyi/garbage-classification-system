...
import { GarbageManagementRecordEventMixedIntoStatisticDetailsArgs } from './garbage-management-record-event-mixed-into-statistic-details-container.model';

@Injectable()
export class GarbageManagementRecordEventMixedIntoStatisticDetailsContainerBusiness {
  constructor(
  ...
  async load(
    args: GarbageManagementRecordEventMixedIntoStatisticDetailsArgs
    ...
    let model = this.converter.Convert(data, [EventType.MixedInto], args.unit);
    return model;
  }
  async getData(
    id: string,
