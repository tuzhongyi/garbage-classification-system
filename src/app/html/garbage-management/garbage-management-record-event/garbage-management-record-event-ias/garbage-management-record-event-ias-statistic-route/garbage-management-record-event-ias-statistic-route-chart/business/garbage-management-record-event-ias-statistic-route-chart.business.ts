...
@Injectable()
export class GarbageManagementRecordEventIasStatisticRouteChartBusiness {
  async load(
    datas: DeviceRoutesStatistic[],
    type: GarbageManagementRecordEventIasStatisticRouteType
  ) {
    switch (type) {
      case GarbageManagementRecordEventIasStatisticRouteType.Meter:
        return this.convert.meter(datas);
      case GarbageManagementRecordEventIasStatisticRouteType.Speed:
        return this.convert.speed(datas);
      case GarbageManagementRecordEventIasStatisticRouteType.Time:
